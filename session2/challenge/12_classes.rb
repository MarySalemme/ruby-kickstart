...
# Include setter methods called numerator and denominator that allow the user to 
# change these values
# Also include a method called to_f that returns the ratio as a float 
#(a number with a decimal point, such as 10.3)
# Also include a method called lowest, which returns a new Fraction, 
